	  ...
	  public ArrayList<Listing> parseListings(String jsonResponse) throws Exception{
		  ...
		  private Listing parseListing(JSONObject jsonObj) throws JSONException{
		    ...
		    try{
		      ...
		      try{
		        Date startTime=(Date) dateFormat.parse(listingInfoObj.getString(this.resources.getString(R.string.ebay_tag_startTime)));
		        listing.setStartTime(startTime);
		        Date endTime=(Date) dateFormat.parse(listingInfoObj.getString(this.resources.getString(R.string.ebay_tag_endTime)));
