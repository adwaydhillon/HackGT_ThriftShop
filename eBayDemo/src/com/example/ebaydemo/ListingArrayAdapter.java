...
public class ListingArrayAdapter extends ArrayAdapter<Listing>{
	  ...
	  public View getView(int position,View convertView,ViewGroup parent){
	    ...
	    TextView titleField=(TextView)layout.findViewById(R.id.fragment_listings_title);
	    titleField.setText(listing.getTitle());
	    TextView priceField=(TextView)layout.findViewById(R.id.fragment_listings_price);
	    priceField.setText("Current price: "+listing.getCurrentPrice());
	    TextView shippingField=(TextView)layout.findViewById(R.id.fragment_listings_shipping);
	    ...
	    if(listing.getListingUrl()!=null){
	      try{
	        ...
	        imageView=(ImageView)layout.findViewById(R.id.fragment_listings_image);
